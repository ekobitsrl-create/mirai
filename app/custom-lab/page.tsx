...
export default function CustomLabPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#09070d] text-white">
      ...
      <section className="relative px-5 pb-16 pt-40 sm:px-6 sm:pt-44 lg:pb-20">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-12 grid items-end gap-8 lg:grid-cols-[1fr_420px] lg:gap-16">
            <div>
              ...
              <h1 className="max-w-4xl font-bold uppercase leading-[0.84] tracking-[-0.075em] text-white" style={{ fontFamily: "var(--font-space-grotesk)" }}>
                <span className="block text-[clamp(3.2rem,10vw,8.2rem)]">Make it</span>
                <span className="block bg-gradient-to-r from-[#c7b8ff] via-primary to-[#d54dff] bg-clip-text text-[clamp(3.2rem,10vw,8.2rem)] text-transparent drop-shadow-[0_0_30px_rgba(145,90,255,0.23)]">yours.</span>
              </h1>
            </div>
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold uppercase tracking-[-0.045em] sm:text-5xl" style={{ fontFamily: "var(--font-space-grotesk)" }}>
                Come funziona
              </h2>
            </div>
