      ...
      <main className="pt-20">
        <section className="max-w-4xl mx-auto px-6 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {[
              { icon: Truck, title: "Spedizione Standard", value: "3-5 giorni lavorativi", desc: "Gratuita per ordini superiori a 99\u20AC" },
              { icon: Clock, title: "Spedizione Express", value: "1-2 giorni lavorativi", desc: "Costo aggiuntivo di 9,90\u20AC" },
              { icon: Globe, title: "Spedizione Internazionale", value: "5-10 giorni lavorativi", desc: "Tariffe variabili in base alla destinazione" },
              { icon: Package, title: "Ritiro in Store", value: "Disponibile a breve", desc: "Ritira gratuitamente nel nostro store di Catania" },
            ].map((item) => (
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Spediamo in tutta Italia e nei principali Paesi europei. Per spedizioni extra-UE, potrebbero essere applicati dazi doganali a carico del destinatario. Per informazioni su destinazioni specifiche, contattaci a{" "}
