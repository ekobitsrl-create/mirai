    ...
    questions: [
      {
        ...
        a: "La spedizione standard e gratuita per ordini superiori a 99\u20AC. Per ordini inferiori, il costo e di 5,90\u20AC. La spedizione express costa 9,90\u20AC.",
      },
      {
        q: "In quanto tempo ricevero il mio ordine?",
        a: "La spedizione standard richiede 3-5 giorni lavorativi, quella express 1-2 giorni. Le spedizioni internazionali richiedono 5-10 giorni lavorativi.",
      },
      {
        q: "Spedite all'estero?",
        a: "Si, spediamo in tutti i Paesi dell'Unione Europea. Per spedizioni extra-UE, contattaci per verificare disponibilita e costi.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Si, nel nostro concept store di Catania offriamo un servizio di personalizzazione. Per il servizio online, contattaci per verificare le opzioni disponibili.",
      },
    ],
  },
]
