...
export const metadata: Metadata = {
  ...
  description: "Scopri MIRAI: streetwear esclusivo e cappelli custom New Era con cristalli e borchie. Pezzi unici fatti a mano. Spedizione gratuita sopra 150\u20AC. Made in Italy.",
  keywords: [
