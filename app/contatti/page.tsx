        ...
        <section className="max-w-4xl mx-auto px-6 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {[
              ...
              { icon: Phone, title: "Telefono", value: "+39 095 123 4567", desc: "Lun - Ven, 10:00 - 18:00" },
              { icon: MapPin, title: "Indirizzo", value: "Catania, Sicilia", desc: "Il nostro concept store aprira presto" },
