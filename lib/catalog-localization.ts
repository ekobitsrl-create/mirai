...
const categoryDescriptions: Record<string, Record<Locale, string>> = {
  ...
  "t-shirt-godspeed": { it: "T-shirt oversize GodSpeed selezionate da MIRAI.", en: "GodSpeed oversized T-shirts selected by MIRAI.", es: "Camisetas oversize GodSpeed seleccionadas por MIRAI.", de: "Von MIRAI ausgewählte GodSpeed Oversize-T-Shirts.", fr: "T-shirts oversize GodSpeed sélectionnés par MIRAI." },
  "t-shirt-god-street": { it: "T-shirt oversize GodSpeed selezionate da MIRAI.", en: "GodSpeed oversized T-shirts selected by MIRAI.", es: "Camisetas oversize GodSpeed seleccionadas por MIRAI.", de: "Von MIRAI ausgewählte GodSpeed Oversize-T-Shirts.", fr: "T-shirts oversize GodSpeed sélectionnés par MIRAI." },
  "t-shirt-god-speed": { it: "T-shirt oversize GodSpeed selezionate da MIRAI.", en: "GodSpeed oversized T-shirts selected by MIRAI.", es: "Camisetas oversize GodSpeed seleccionadas por MIRAI.", de: "Von MIRAI ausgewählte GodSpeed Oversize-T-Shirts.", fr: "T-shirts oversize GodSpeed sélectionnés par MIRAI." },
