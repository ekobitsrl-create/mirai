...
const categoryDescriptions: Record<string, Record<Locale, string>> = {
  ...
  canotte: { it: "Canotte e smanicati streetwear MIRAI.", en: "MIRAI streetwear tank tops and sleeveless pieces.", es: "Camisetas sin mangas y prendas sleeveless streetwear MIRAI.", de: "Streetwear-Tanktops und ärmellose Styles von MIRAI.", fr: "Débardeurs et pièces sans manches streetwear MIRAI." },
