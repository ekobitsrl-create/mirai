...
const categoryDescriptions: Record<string, Record<Locale, string>> = {
  ...
  "t-shirt-god-speed": { it: "T-shirt God Speed selezionate da MIRAI.", en: "God Speed T-shirts selected by MIRAI.", es: "Camisetas God Speed seleccionadas por MIRAI.", de: "Von MIRAI ausgewählte God Speed T-Shirts.", fr: "T-shirts God Speed sélectionnés par MIRAI." },
