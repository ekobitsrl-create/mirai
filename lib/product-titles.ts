...
const TITLE_PREFIXES: Record<ProductKind, string> = {
  "t-shirt": "T-shirt Oversize Premium Streetwear MirΛi",
  "custom-t-shirt": "T-shirt Personalizzata Premium Streetwear MirΛi",
  canotta: "Canotta Oversize Premium Streetwear MirΛi",
  camicia: "Camicia Oversize Premium Streetwear MirΛi",
  bermuda: "Bermuda Premium Streetwear MirΛi",
  shorts: "Shorts Premium Streetwear MirΛi",
  jeans: "Jeans Premium Streetwear MirΛi",
  pantaloni: "Pantaloni Premium Streetwear MirΛi",
  felpa: "Felpa Oversize Premium Streetwear MirΛi",
  tuta: "Tuta Premium Streetwear MirΛi",
  giacca: "Giacca Premium Streetwear MirΛi",
  cappello: "Cappello Custom Premium Streetwear MirΛi",
  sneakers: "Sneakers Premium Streetwear MirΛi",
  occhiali: "Occhiali da Sole Premium Streetwear MirΛi",
  profumo: "Extrait de Parfum Premium MirΛi 100 ml",
  accessorio: "Accessorio Premium Streetwear MirΛi",
  generic: "Prodotto Premium Streetwear MirΛi",
}
