...
export const translations = {
  it: {
    ...
    productDetail: {
      ...
      freeReturnDesc: "Entro 14 giorni",
      ...
      shippingInfo: "Spedizione sempre gratuita. La consegna varia in base al prodotto: 3–5 oppure 7–12 giorni lavorativi.",
      returnInfo: "Reso gratuito in Italia entro 14 giorni dalla ricezione. Il prodotto deve essere nelle condizioni originali con tutti i cartellini.",
    ...
    features: {
      ...
      easyReturnsDesc: "14 giorni per richiedere il reso degli articoli idonei.",
  ...
  en: {
    ...
    productDetail: {
      ...
      shippingInfo: "Shipping is always free. Delivery varies by product: 3–5 or 7–12 business days.",
      returnInfo: "Free returns in Italy within 14 days of receipt. The product must be in original condition with all tags.",
    ...
    features: {
      ...
      easyReturnsDesc: "14 days to request a return for eligible items.",
  ...
  es: {
    ...
    productDetail: {
      ...
      freeReturnDesc: "Dentro de 14 días",
      ...
      shippingInfo: "El envío es siempre gratuito. La entrega varía según el producto: 3–5 o 7–12 días laborables.",
      returnInfo: "Devolución gratuita en Italia dentro de los 14 días de la recepción. El producto debe estar en condiciones originales con todas las etiquetas.",
    ...
    features: {
      ...
      easyReturnsDesc: "14 días para solicitar la devolución de artículos elegibles.",
  ...
  de: {
    ...
    productDetail: {
      ...
      freeReturnDesc: "Innerhalb von 14 Tagen",
      ...
      shippingInfo: "Der Versand ist immer kostenlos. Die Lieferung dauert je nach Produkt 3–5 oder 7–12 Werktage.",
      returnInfo: "Kostenlose Rücksendung in Italien innerhalb von 14 Tagen nach Erhalt. Das Produkt muss sich im Originalzustand mit allen Etiketten befinden.",
    ...
    features: {
      ...
      easyReturnsDesc: "14 Tage, um die Rückgabe berechtigter Artikel anzufordern.",
  ...
  fr: {
    ...
    productDetail: {
      ...
      shippingInfo: "La livraison est toujours gratuite. Le délai varie selon le produit : 3–5 ou 7–12 jours ouvrables.",
      returnInfo: "Retour gratuit en Italie dans les 14 jours suivant la réception. Le produit doit être dans son état d'origine avec toutes les étiquettes.",
    ...
    features: {
      ...
      easyReturnsDesc: "14 jours pour demander le retour des articles éligibles.",
