...
export function GuideIndex() {
  ...
  const guides = SEO_GUIDES.map((guide) => localizeSeoGuide(guide, locale))
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-5 font-[family-name:var(--font-space-grotesk)] text-[clamp(2.6rem,7vw,6rem)] font-bold uppercase leading-[0.9] tracking-[-0.055em]">
              {ui("Guide")} <span className="bg-gradient-to-r from-[#c7b8ff] via-primary to-[#d54dff] bg-clip-text text-transparent">streetwear.</span>
            </h1>
            <p className="mt-7 max-w-2xl text-sm leading-7 text-white/55 sm:text-base">
              {ui("Fit, materiali, abbinamenti e custom culture spiegati in modo concreto. Guide per scegliere meglio i capi e costruire uno stile personale.")}
            </p>
          </div>
        </div>
      </section>
