        ...
        <div className="flex flex-col animate-fade-up delay-100">
          ...
          <div className="mt-8 border-t border-[#e4e0ec]">
            ...
            <details className="group border-t border-[#e4e0ec]">
              ...
              <div className="pb-4 text-sm text-[#6b5f7d] leading-relaxed space-y-2">
                <p>{"Spedizione gratuita per ordini superiori a 150\u20AC. Consegna in 3-5 giorni lavorativi."}</p>
                <p>Reso gratuito entro 30 giorni dalla ricezione. Il prodotto deve essere nelle condizioni originali con tutti i cartellini.</p>
              </div>
            </details>
          </div>
        </div>
