        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex items-center gap-4">
              <Link href="https://www.instagram.com/thentribe?igsh=MXByMzl4Y2M2c2ZwbA==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-primary transition-colors">
