  ...
  return (
    <div className="relative z-50">
      ...
      <InfiniteMarquee speed="normal" className="bg-secondary border-b border-border py-2">
        {["Spedizione Gratuita sopra i 150\u20AC", "Resi Gratuiti entro 30 Giorni", "Pagamento Sicuro e Protetto", "Spedizione Express Disponibile"].map((msg, i) => (
      ...
      {/* Promo discount bar - bold, like Black Island */}
